...
const Input = styled.input`
  ...
  border-bottom-color: ${props => (props.focused ? `#b7b7bb;` : 'transparent')};
  color: #b7b7bb;
...
export const ParticipantsListMobile = props => {
  ...
  const { data, loading } = useGetParticipantsList({ date, search });
